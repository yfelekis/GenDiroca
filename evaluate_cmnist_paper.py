...
# # ============================================================
# # 2. Transforms (Rotation & Blur Only)
# # ============================================================
...
#     pbar = tqdm(total=count * len(param_names) * len(levels) * N_TRIALS, desc="Evaluating")
...
#         # Visuals
#         fig, axes = plt.subplots(len(vis_rows), 5, figsize=(12, 12))
...
#         plt.tight_layout()
#         fig.suptitle("CMNIST Shift Visuals (Rot/Blur)", y=1.02, fontsize=16)
...
#     res, om, dll, dhl = load_eval_state(args.eval_dir)[:4] # Ignoring fold list for simple load
    
#     levels_dict = {
#         "rotation": {"low": 10.0, "high": 90.0},
#         "blur": {"low": 0.1, "high": 2.0}
#     }
    
#     print("Evaluating Rotation & Blur...")
#     df = evaluate_main(res, om, dll, dhl, args.n_trials, levels_dict)
#     vis_rows, vis_lbls = generate_visuals(dll, levels_dict)
#     make_pdf_report(df, vis_rows, vis_lbls, "cmnist_paper_results.pdf")
